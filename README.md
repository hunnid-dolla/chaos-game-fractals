...
```shell
python main.py --seed 32.123531 -i 5000 -f swirl:1.0,horseshoe:0.8 -t 2
```
...
4. Реализуйте механизм многопоточной обработки; Так как это CPU-bound задача стоит использовать модуль **multiprocessing**;
